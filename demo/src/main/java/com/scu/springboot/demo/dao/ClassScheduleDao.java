...
public interface ClassScheduleDao {
     ...
     * 查询指定行数据
     *
     * @param classSchedule 查询条件
     * @param pageable         分页对象
     * @return 对象列表
     */
    List<ClassSchedule> queryAllByLimit(ClassSchedule classSchedule, @Param("pageable") Pageable pageable);
     ...
     * @return 总行数
     */
    long count(ClassSchedule classSchedule);
     ...
     *
     * @param entities List<ClassSchedule> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<ClassSchedule> entities);
     ...
     */
    int insertOrUpdateBatch(@Param("entities") List<ClassSchedule> entities);
